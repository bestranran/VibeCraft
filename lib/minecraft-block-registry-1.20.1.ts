/**
 * Generated from Prismarine minecraft-data 3.111.0.
 * Target: Minecraft Java Edition 1.20.1.
 * Air variants are intentionally excluded because VoxelStructure stores occupied blocks only.
 */
export const MINECRAFT_JAVA_VERSION = "1.20.1" as const;
...
export type MinecraftBlockId = (typeof MINECRAFT_BLOCK_IDS)[number];
